 ...
 */
    ...
    public boolean checkForWin(int[][] board) {
        ...
        for (int i = 0; i < 6; i++) {
            for (int j = 0; j < 4; j++) {
                boolean flag = board[i][j] == board[i][j + 1] && board[i][j + 1] == board[i][j + 2] && board[i][j + 2] == board[i][j + 3];
                if (flag) {
                    return true;
                }
            }
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 7; j++) {
                boolean flag = board[i][j] == board[i + 1][j] && board[i + 1][j] == board[i + 2][j] && board[i + 2][j] == board[i + 3][j];
                if (flag) {
                    return true;
                }
            }
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 4; j++) {
                boolean flag = board[i][j] == board[i + 1][j + 1] && board[i + 1][j + 1] == board[i + 2][j + 2] && board[i + 2][j + 2] == board[i + 3][j + 3];
                if (flag) {
                    return true;
                }
            }
    ...
    public static void main(String[] args) {
        //pseudo testing case, column 2 gives a win to player 1 so method should return 1.
